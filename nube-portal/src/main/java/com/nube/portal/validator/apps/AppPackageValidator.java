...
public class AppPackageValidator {
	...
	public Properties validate(String appFolder) throws NubeException,
		...
		if (!pkgFolder.isDirectory()) {
			throw new NubeException(
					"App package folder not found. Provide valid folder before validation begins");
		}
	...
	public Properties validateLicKey(File pkgFolder) throws IOException,
			NubeException {
